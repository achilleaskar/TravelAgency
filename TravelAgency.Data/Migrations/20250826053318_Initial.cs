        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OldBalance = table.Column<decimal>(type: "decimal(12,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositDueDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    OptionDueDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<DateTime>(type: "timestamp(6)", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allotments_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsSpecific = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllotmentRoomTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllotmentRoomTypes_Allotments_AllotmentId",
                        column: x => x.AllotmentId,
                        principalTable: "Allotments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AllotmentRoomTypes_RoomTypes_RoomTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllotmentRoomTypes_AllotmentId_RoomTypeId",
                table: "AllotmentRoomTypes",
                columns: new[] { "AllotmentId", "RoomTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AllotmentRoomTypes_RoomTypeId",
                table: "AllotmentRoomTypes",
                column: "RoomTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Allotments_HotelId",
                table: "Allotments",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_Allotments_OptionDueDate",
                table: "Allotments",
                column: "OptionDueDate");
