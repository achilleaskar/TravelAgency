...
namespace TravelAgency.Desktop.ViewModels
{
    public partial class CitiesViewModel : ObservableObject
    {
        ...
        public CitiesViewModel(IDbContextFactory<TravelAgencyDbContext> dbf) => _dbf = dbf;

        public bool CanEdit => Selected != null && !IsEditing;
        public bool CanDelete => Selected != null && !IsEditing;
        partial void OnSelectedChanged(City? value) { OnPropertyChanged(nameof(CanEdit)); OnPropertyChanged(nameof(CanDelete)); }
